...
static func _rows() -> Array:
	return [
		...
		["waypoint", "Waypoint", C, "match", "Move any of your pieces to an empty square in your zone.", true],
		["swap_fates", "Swap Fates", C, "match", "Swap any two of your pieces.", true],
		["wings", "Wings", C, "match", "A piece of yours moves like a queen this turn.", true],
		["broaden_the_realm", "Broaden the Realm", C, "armed", "Arm before a match: your zone is 6 tiles bigger.", true],
		["call_to_arms", "Call to Arms", C, "match", "Two temporary pawns appear in your zone.", true],
		["iron_skin", "Iron Skin", C, "match", "A piece of yours can't be captured by pawns or knights this match.", true],
		["curse_of_stillness", "Curse of Stillness", C, "match", "An enemy piece can't move for 2 of the AI's turns.", true],
		["banishing", "Banishing", C, "match", "Remove a common-tier enemy piece (never the king; no score).", true],
		["sow_discord", "Sow Discord", C, "match", "The AI's next move is random.", true],
		...
		["marked_for_death", "Marked for Death", U, "match", "Pick an enemy piece: capturing it scores x2.", true],
		["quickening", "Quickening", U, "match", "+2 moves this match.", true],
		["second_chance", "Second Chance", U, "armed", "Arm before a match: if you'd run out of moves short of the target, gain 2 moves once.", true],
		["haste", "Haste", U, "match", "Your next 3 moves cost nothing.", true],
		["sanctuary", "Sanctuary", U, "match", "A piece of yours can't be captured for 3 of your turns.", true],
		["reinforcements", "Reinforcements", U, "armed", "Arm before a match: +5 allocated points this match.", true],
		["rite_of_rebirth", "Rite of Rebirth", U, "match", "The last piece you lost this match returns to its starting square.", true],
		["transmutation", "Transmutation", U, "match", "A piece of yours becomes another of the same tier for this match.", true],
		["guardian_spirit", "Guardian Spirit", U, "armed", "Arm before a match: the first piece you'd lose for good stays in your roster.", true],
		["shattered_shields", "Shattered Shields", U, "match", "The enemy's protections and auras stop working this match.", true],
		["reveal_weakness", "Reveal Weakness", U, "match", "The enemy king can't move for 3 turns.", true],
		...
		# ---- rare (11)
		["borrowed_hour", "Borrowed Hour", R, "match", "Take an extra move right now.", true],
		["twin_sun", "Twin Sun", R, "match", "This turn you may move two different pieces.", true],
		["turning_tide", "Turning Tide", R, "match", "Rewind the opponent's last move.", true],
		["stone_ward", "Stone Ward", R, "match", "No piece can capture on a chosen square for 3 turns.", true],
		...
		["hex_of_the_boss", "Hex of the Boss", R, "match", "The boss's legendary is frozen for 3 turns.", true],
		["mantle_of_the_phoenix", "Mantle of the Phoenix", R, "armed", "Arm before a match, pick a piece: the first time it's captured it returns 3 turns later.", true],
		["field_promotion", "Field Promotion", R, "match", "Promote any pawn, anywhere, to a piece of your choice up to a rook.", true],
		# ---- legendary (5)
		["final_blow", "Final Blow", L, "armed", "Arm before a match: captures on your last move score x3.", true],
		["frozen_moment", "Frozen Moment", L, "match", "The AI skips its next turn.", true],
		["echo_of_steel", "Echo of Steel", L, "match", "Copy one of your pieces onto a free zone square for this match.", true],
